...
_COMPARISON_MARKERS = [
    "різниця", "разница", "vs", "проти", "против", "відрізня", "отлича",
    "порівня", "сравни", "чим відрізн", "чем отлич", "у чому різн", "в чем разница",
    "конкурент", "конкуренти", "конкуренты", "competitor",
    "альтернатив", "альтернатива", "аналог", "аналоги",
]
