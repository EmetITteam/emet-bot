...
FOLDER_CERTS = '1ma-6CNO2FeHaicbRag7RvStkf5Rp1MyJ'  # Сертификаты → db_index_certs_openai
...
def run_indexing():
    ...
    build_db_for_folder(service, FOLDER_CERTS, "data/db_index_certs_openai", "Сертификаты")
