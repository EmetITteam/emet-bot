...
async def process_text_query(text: str, message: types.Message, state: FSMContext):
    ...
    _EMET_PRODUCTS = [
        "ellansé", "ellanse", "elanse", "еланс", "елансе", "элансе", "эллансе", "ellanсе",
        "neuramis", "нейрамис", "нейраміс",
    ...
    _all_detected_products = [p for p in _EMET_PRODUCTS if _match_product(p, t_lower)]
